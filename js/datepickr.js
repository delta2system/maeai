...
var datepickr = (function() {
	...
	function buildCurrentMonth(config, currentMonthView, currentYearView) {
		...
		//var currentYearViews=currentYearView+543;
		return buildNode('span', { className: 'current-month' }, date.month.string(config.fullCurrentMonth, currentMonthView) + ' ' + currentYearViews);
