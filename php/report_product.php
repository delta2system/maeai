...
$dto=$d2[2]." ".thai_month($d2[1])." ".$d2[0];
    ...
    print "<td class='topbar'>เลขที่ใบเบิก</td>";
	print "<td class='topbar'>พนักงาน</td>";
	print "<td class='topbar'  colspan='2' style='width:200px;'>แผนก</td>";
    ...
    $strSQL = "SELECT * from bill where barcode = '".$_SESSION["d_barcode"]."' AND status = 'OWH' AND dateday between '".$_SESSION["d_day"]."' AND '".$_SESSION["d_to"]."' ORDER By dateday ASC ";
    ...
    while( $data = mysql_fetch_array($resultSQL)){
        ...
        print "<td style='text-align:center;font-size:13px;padding:5px 0px;padding:5px 0px;'>".$data["nobill"]."</td>";
   ...
   // print "</tbody>";
    ...
    print "<td colspan='4' style='height:30px;border-top:1px solid #909090;'></td><td style='text-align:right;font-weight:bold;font-size:12px;border-top:1px solid #909090;'>จำนวนที่ใช้ไป</td><td style='text-align:center;border-bottom-style:double;font-weight:bold;border-top:1px solid #909090;'>".number_format(array_sum($pcs_department))."</td>";
