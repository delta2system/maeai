        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              ?>
              <h3><?echo number_format($pcs);?> <span style="font-size:10px;">ชิ้น</span></h3>
            ...
            <a href="report_warehouse.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?
              $sql = "SELECT sum(pcs*price_in) from stock_product WHERE pcs > '0'  ";
              list($total_warehouse) = Mysql_fetch_row(Mysql_Query($sql));
              ?>
              <h3><?echo number_format($total_warehouse,2);?><span style="font-size: 10px">฿</span></h3>

              <p>มูลค่า พัสดุทั้งหมด</p>
            </div>
            <div class="icon">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="dashboard/#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="dashboard/#sales-chart" data-toggle="tab">Donut</a></li>
              <li class="pull-left header"><i class="fa fa-inbox"></i> การเบิกพัสดุ</li>
            </ul>
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="dashboard/#">Add new event</a></li>
                    <li><a href="dashboard/#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="dashboard/#">View calendar</a></li>
                  </ul>
                </div>
