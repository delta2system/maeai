...
if($row_bill){
  ...
  $strSQL = "SELECT * FROM  tbl_import2_head where row_bill = '$row_bill' limit 1 ";
...
?>
    ...
    <body>
        ...
        <table style="width:680px;margin:0px auto;">
            <tr><td style="text-align: center;font-weight: bold;" colspan="2">รายงานผลการตรวจรับพัสดุนอกคลัง</td></tr>
            ...
            <tr><td style="height:10px;" colspan="2">
                เลขที่ใบเสร็จ/ใบส่งของ ......................................<span style="position: absolute;width:130px;height:20px;margin-left: -130px;text-align: center;"><nl style="background-color:#ffffff; "><?=$arrCol[nobill_recipt]?></nl></span>
                หมวด .............................................<span style="position: absolute;width:160px;height:20px;margin-left: -160px;text-align: center;"><nl style="background-color:#ffffff; "><?=$arrCol[type_hire]?></nl></span>
                หน่วยเบิก ...........................................<span style="position: absolute;width:150px;height:20px;margin-left: -150px;text-align: center;">
            <nl style="background-color:#ffffff; "><?
            $sql = "SELECT name from department WHERE code = '".$arrCol[department]."' ";
            list($name_department) = Mysql_fetch_row(Mysql_Query($sql));
            ...
            <?
            $result = mysql_query("SELECT * FROM tbl_import2_body where row_bill = '$row_bill'");
