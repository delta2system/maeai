  ...
  <script src="../js/jquery-1.8.0.min.js"></script>
	...
	function return_detail(){
            ...
            $.ajax({ 
                ...
                type: "POST",
                data: 'submit=return_tbl_typeofmoney&search='+$("input[name=search]").val(),
            })
		...
		function edit_d(rx){
		 $.ajax({ 
                url: "mysql_tbl_typeofmoney.php" , type: "POST", data: 'submit=return_tbl_typeofmoney&row_id='+rx,
            })
            .success(function(result) {
            	//alert(result);
            var obj = jQuery.parseJSON(result);
		...
		function add_personal(){
			...
			$.ajax({ 
                url: "mysql_tbl_typeofmoney.php" ,
                type: "POST",
                data: 'submit=return_tbl_typeofmoney_no',
            })
            .success(function(result) {
		...
		function save_customer(){
          ...
          $.ajax({ 
                url: "mysql_tbl_typeofmoney.php" ,
                type: "POST",
                data: 'submit=save_tbl_typeofmoney'+data,
            })
            .success(function(result) {
            	//alert(result);
       //        var obj = jQuery.parseJSON(result);
		...
		function del_customer(){
			...
			var data = "&row_id="+$("input[name=edit_code]").val();
   			...
   			$.ajax({ 
                url: "mysql_tbl_typeofmoney.php" ,
                type: "POST",
                data: 'submit=del_tbl_typeofmoney'+data,
            })
            .success(function(result) {
            	$("#display_edit").hide();
           		$('#display_user').show();
...
<body>
<div style="width:100%;height:100px;left:0px;top:0px;background-color:#4db8ff;"><br><br>
	<div class="head_bar"> <i class="fa fa-braille"></i>  | เพิ่ม/แก้ไข ที่มาเงิน</div>
