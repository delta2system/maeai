...
$sum_x=array("");
$sum_y=array("");
$sql = "SELECT * from department where group_location = '2' ORDER By code  ASC";
...
echo "<td style='text-align: right;border:1px solid #a2a2a2;'><a href='report_department.php?dateday=01-".$_GET["month1"]."-".$_GET["year1"]."&today=31-".$_GET["month2"]."-".$_GET["year2"]."&department=".$row["code"]."&group_type=".$rowx[$t]."' target='_blank'>".recheck_num($sum_OWH)."</a>&nbsp;&nbsp;</td>";
