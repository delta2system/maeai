...
// $sql = "SELECT group_type.detail from stock_product INNER Join hire_type on stock_product.group_type = hire_type.code where barcode = '$str'  limit 1  ";
...
$dto=$d2[0]." ".thai_month($d2[1])." ".$d2[2];
  ...
  print "<thead>";
  print "<tr><td colspan='4' style='height:50px;font-size:20px;font-weight:bold;color:#3366ff;'>สรุปยอดจัดซื้อ <span style='color:#606060;'>".$g["supply_id"]." : ".supply_name($g["supply_id"])."</span></td>";
  ...
  print "</tr></thead><tbody>";
    ...
    $strSQL = "SELECT * from egp_product where no = '".$g[no]."' AND store = 'out' AND status = '1' ";
