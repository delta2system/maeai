...
$dto=$d2[0]." ".thai_month($d2[1])." ".$d2[2];
  ...
  print "<thead>";
  print "<tr><td colspan='4' style='height:50px;font-size:20px;font-weight:bold;color:#3366ff;'>สรุปยอดจัดซื้อ <span style='color:#606060;'>".group_name($g["group_type"])."</span></td>";
  ...
  print "</tr></thead><tbody>";
    ...
    $strSQL = "SELECT * from egp_product where group_type = '".$g[group_type]."' AND store = 'out' AND status = '1' ";
