...
$dto=$d2[2]." ".thai_month($d2[1])." ".$d2[0];
	...
	print "<thead>";
	print "<tr><td colspan='4' style='height:50px;font-size:20px;font-weight:bold;color:#3366ff;'>สรุปยอดรับสินค้า <span style='color:#606060;'>$g[customer_id] : $g[customer_name]</span></td>";
    ...
    $strSQL = "SELECT * from bill where customer_id = '".$g[customer_id]."' AND status = 'INV' AND dateday between '".$_SESSION["d_day"]."' AND '".$_SESSION["d_to"]."' ORDER By group_type ASC ";
