...
<head>
  ...
  <script src="../js/jquery-1.8.0.min.js"></script>
	...
	function return_detail(){
            ...
            $.ajax({ 
                url: "mysql_tbl_cal.php" ,
                type: "POST",
                data: 'submit=return_tbl_cal&search='+$("input[name=search]").val(),
            })
		...
		function edit_d(rx){
		 $.ajax({ 
                url: "mysql_tbl_cal.php" ,
                type: "POST",
                data: 'submit=return_tbl_cal&row_id='+rx,
            })
            .success(function(result) {
            	//alert(result);
            var obj = jQuery.parseJSON(result);
...
<body>
<div style="width:100%;height:100px;left:0px;top:0px;background-color:#47d147;"><br><br>
	<div class="head_bar"> <i class="fa fa-braille"></i>  | เพิ่ม/แก้ไข การคำนวณค่าเสื่อม</div>
...
<div id="display_user" style="margin:0px auto;width:100%;height:400px;">
	<div>
			<table style="width:450px;margin:0px auto;" id="detail_table">
				<thead >
					<td class="top_bar" style="width:40px;">รหัส</td>
					<td class="top_bar">ประเภท</td>
          			<td class="top_bar" style="width:100px;"><input type="text" name="search" onkeyup="return_detail()" style="font-size:15px;width:120px;border:1px solid #2eb82e;border-radius: 5px;"><i class="fa fa-search" style="color:#a2a2a2;margin-left: -20px;"></i></td>
				</thead>
				<tbody>
...
<div id="display_edit" style="display:none;width:70%;height:400px;background-color: #ffffff;position: absolute;top:120px;right: 0px;">
	...
	<div style="margin-top:20px;color:#3385ff; "> ประเภท : <input type="text" name="edit_detail" style="width:285px;font-size: 15px;padding: 5px 5px;color:#555555;"></div>
