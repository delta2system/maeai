...
echo "<td style='text-align: right;border:1px solid #a2a2a2;'><a href='report_department.php?dateday=01-".$_GET["month"]."-".$_GET["year"]."&today=31-".$_GET["month"]."-".$_GET["year"]."&department=".$row["code"]."&group_type=".$rowx[$t]."' target='_blank'>".recheck_num($total_outstore+$sum_OWH)."</a>&nbsp;&nbsp;</td>";
