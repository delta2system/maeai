...
<head>
  ...
  <script src="../js/jquery-1.8.0.min.js"></script>
	...
	function return_detail(){
            ...
            $.ajax({ 
                url: "mysql_material_type.php" ,
                type: "POST",
                data: 'submit=return_material_type&search='+$("input[name=search]").val(),
            })
		...
		function edit_d(rx){
		 $.ajax({ 
                url: "mysql_material_type.php" ,
                type: "POST",
                data: 'submit=return_material_type&row_id='+rx,
            })
            .success(function(result) {
            	//alert(result);
            var obj = jQuery.parseJSON(result);
		...
		function add_personal(){
			...
			$.ajax({ 
                url: "mysql_material_type.php" ,
                type: "POST",
                data: 'submit=return_material_type_no',
            })
            .success(function(result) {
		...
		function save_customer(){
          ...
          $.ajax({ 
                url: "mysql_material_type.php" ,
                type: "POST",
                data: 'submit=save_material_type'+data,
            })
            .success(function(result) {
            	//alert(result);
       //        var obj = jQuery.parseJSON(result);
		...
		function del_customer(){
			...
			var data = "&row_id="+$("input[name=edit_code]").val();
   			...
   			$.ajax({ 
                url: "mysql_material_type.php" ,
                type: "POST",
                data: 'submit=del_material_type'+data,
            })
            .success(function(result) {
            	$("#display_edit").hide();
           		$('#display_user').show();
...
<div style="width:100%;height:100px;left:0px;top:0px;background-color:#ffbf00;"><br><br>
	<div class="head_bar"> <i class="fa fa-braille"></i>  | เพิ่ม/แก้ไข ประเภทคลังนอก</div>
