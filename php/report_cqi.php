...
<html>
<head>
	<title> แบบฟอร์มเก็บข้อมูลงานพัสดุ(CQI 1)</title>
...
<table id="table_detail" style="width:21cm;margin:0px auto;">
  <thead>
    <tr><td colspan="20" style="text-align: center;">แบบฟอร์มเก็บข้อมูลงานพัสดุ(CQI 1)</td></tr>
  	<tr><td colspan="20" style="text-align: center;font-size: 18px;font-weight: bold;"> ประจำเดือน 
      <select name="month" style="font-size: 17px;border:0px solid #000000;" onchange="$('#loading').show();return_dataall();">
      <?
      for ($i=1; $i <= 12 ; $i++) { 
    ...
    ?>
  	 ...
  	 <tr>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" rowspan="2">ลำดับ</td>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" rowspan="2">หน่วยเบิก</td>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" rowspan="2">รวมเบิกได้<br>(ชิ้น)</td>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" colspan="5">จำนวนพัสดุ<br>ที่เบิกได้</td>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" rowspan="2">รวมเบิก<br>ไม่ได้</td>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" colspan="5">จำนวนพัสดุ<br>ที่เบิกไม่ได้</td>    
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" rowspan="2">รวมยืม</td>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;" colspan="5">จำนวนยืมก่อน</td>
        <tr>
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">1</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">2</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">3</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">4</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">5</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">1</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">2</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">3</td>  
        <td class="topbar" style="height:30px;border:1px solid #909090;text-align: center;">4</td>  
...
<div id="loading" style="display:none;z-index:5;background-color:#ffffff;position:fixed;width:414px;height:233px;left:50%;height:50%;margin-left: -207px;">
  <img src="../images/loading.gif" style="width:414px;">
</div>
<script type="text/javascript">
 ...
 $("#loading").show();
  $.ajax({ 
    ...
    var tr = "<tr>";
        ...
        tr = tr + "<td class='border_bt' style='text-align: left;font-size:13px;'>&nbsp;&nbsp;"+val["customer_name"]+"</td>";
        tr = tr + "<td class='border_bt' style='text-align: center;font-size:13px;'>"+addCommas(val["sumpcs"])+"</td>";
        tr = tr + "<td class='border_bt' style='text-align: right;font-size:13px;'>"+val["pcs0"]+"</td>";
        tr = tr + "<td class='border_bt' style='text-align:center;font-size:13px;'>"+val["pcs1"]+"</td>";
        tr = tr + "<td class='border_bt' style='text-align:center;font-size:13px;'>"+val["pcs2"]+"</td>";
        tr = tr + "<td class='border_bt' style='text-align:center;font-size:13px;'>"+val["pcs3"]+"</td>";
        tr = tr + "<td class='border_bt' style='text-align:center;font-size:13px;'>"+val["pcs4"]+"</td>";
