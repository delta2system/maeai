...
วิธีเฉพาะเจาะจง ซึ่งมีรายละเอียด ดังต่อไปนี้  
   ...
   <div class="div_edit" id="div_edit7" style="margin-left: 76px;">๑. เหตุผลความจำเป็นที่ต้องซื้อ</div>
   <div class="div_edit" id="div_edit8" style="margin-left: 96px;">เพื่อใช้ภายในหน่วยงาน และสำรองคลัง<?=$co[company_name]?></div>
   <div class="div_edit" id="div_edit9" style="margin-left: 76px;">๒. รายละเอียดของ<?=str_replace("จัดซื้อ", "", $pcs_detail);?> คือ</div>
   <div class="div_edit" id="div_edit10" style="margin-left: 96px;">
    <?=$product?>
   </div>
   <div class="div_edit" id="div_edit11" style="margin-left: 76px;">๓. ราคากลางของพัสดุที่จะซื้อจำนวน <?=$total_bath?> บาท (<?=$total_bath_word?>)</div>

   <div class="div_edit" id="div_edit12" style="margin-left: 76px;">๔. วงเงินที่จะซื้อ</div>
   <div class="div_edit" id="div_edit13" style="margin-left: 96px;">
   เงินนอกงบประมาณจาก จำนวน <?=$total_bath?> บาท (<?=$total_bath_word?>)
   </div>

   <div class="div_edit" id="div_edit14" style="margin-left: 76px;">๕. กำหนดเวลาที่ต้องการใช้พัสดุ หรือให้งานแล้วเสร็จภายใน ๓๐ วัน นับจากวันที่ลงนามในสัญญา</div>
   <div class="div_edit" id="div_edit15" style="margin-left: 96px;">
   เงินนอกงบประมาณจาก <?=$total_bath?> บาท (<?=$total_bath_word?>)
   </div>
   <div class="div_edit" id="div_edit16" style="margin-left: 76px;">๖. วิธีที่จะซื้อ และเหตุผลที่ต้องซื้อ</div>
   <div class="div_edit" id="div_edit17" style="margin-left: 96px;">
   ...
   <div class="div_edit" id="div_edit18" style="margin-left: 76px;">๗. หลักเกณฑ์การพิจารณาคัดเลือกข้อเสนอ</div>
   <div class="div_edit" id="div_edit19" style="margin-left: 96px;">
   การพิจารณาคัดเลือกข้อเสนอโดยใช้เกณฑ์ราคา
   </div>
   <div class="div_edit" id="div_edit20" style="margin-left: 76px;">๘. การขออนุมัติแต่งตั้งคณะกรรมการต่างๆ</div>
   <div class="div_edit" id="div_edit21" style="margin-left: 96px;">
   ผู้แต่งตั้งผู้ตรวจรับพัสดุ
   </div>
   <div class="div_edit" id="div_edit22" style="margin-left: 76px;">๙. อนาจในการอนุมติให้ดำเนินการในครั้งนี้ เป็นอำนาจของผู้อำนวยการ<?=$co[company_name]?> ตามคำสั่ง จังหวัดเชียงใหม่ ที่ ๔๙๖๐/๒๕๖๑ ลงวันที่ ๒๖ พฤศจิกายน ๒๕๖๑</div>

   <div class="div_edit" id="div_edit23" style="margin-left: 76px;margin-top: 30px;">จึงเรียนมาเพื่อโปรดพิจารณา หากเห็นชอบขอได้โปรด</div>
   <div class="div_edit" id="div_edit24" style="margin-left: 90px;">๑. อนุมัติให้ดำเนินการ ตามรายละเอียดในรายงานขอซื้อดังกล่าวข้างต้น</div>
   <div class="div_edit" id="div_edit25" style="margin-left: 90px;">๒. ลงนามในคำสั่งแต่งตั้งผู้ตรวจรับพัสดุ
 </div> 
...
<div class="div_edit" id="div_edit27" style="width:300px;height:80px;text-align: center;border:0px solid #ffee00;margin-top: 50px;">
  <br>
 <?=$office02?>
</div>
...
<div class="div_edit" id="div_edit34" style="width:600px;text-align: left;border:0px solid #ffee00;margin-left: 140px;margin-top: 10px;">
  ผู้ตรวจรับพัสดุ<br>
   &nbsp;&nbsp;นางกนกกร ไลไส่&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ผู้ตรวจรับพัสดุ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; พยาบาลวิชาชีพชำนาญการ
</div>
...
<div class="div_edit" id="div_edit36" style="width:270px;height:60px;text-align: center;border:0px solid #ffee00;margin-left: 420px;">
  สั่งวันที่ <?=$dateday1?><br>
</div>
<div class="div_edit" id="div_edit37" style="width:270px;height:120px;text-align: center;border:0px solid #ffee00;margin-left: 420px;">
  <br>
<?=$director?>
</div>
</div>
...
<div class="div_edit" id="div_edit39" style="width:700px;height:37px;font-weight:normal;text-align: center;margin:0px auto;">แบบแสดงความบริสุทธิ์ใจในการจัดซื้อจัดจ้างทุกวิธีของหน่วยงาน</div>
...
<div style="width:300px;height:80px;text-align: center;border:0px solid #ffee00;margin-left: 420px;margin-top: 40px;padding-top: 100px;" class="div_edit" id="div_edit66" >
<?=$office01?>
</div>

<div style="margin-left:60px;width:350px;height:80px;text-align: left;border:0px solid #ffee00;margin-top: -100px;padding-top: 100px;" class="div_edit" id="div_edit67" >
...
<div class="div_edit" id="div_edit68"  style="margin-left:60px;width:300px;height:80px;text-align: center;border:0px solid #ffee00;margin-top: 50px;padding-top:80px;">
  <?=$office02?>
</div>

<div class="div_edit" id="div_edit69"  style="width:300px;height:120px;text-align: center;border:0px solid #ffee00;margin-left: 420px;margin-top: -40px;">
  <br>
<?=$director?>
</div>
</div>
...
<div class="div_edit" id="div_edit72" style="margin-left:60px;margin-top:10px;width:660px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ผุ้ได้รับการคัดเลือก ได้แก่ <?=$supply_name?> (ส่งออก,ขายส่ง,ขายปลีก,ให้บริการ,ผู้ผลิต) โดยเสนอราคา เป็นเงินทั้งสิ้น <?=$total_bath?> บาท (<?=$total_bath_word?>) รวมภาษีมูลค่าเพิ่มและภาษีอื่น ค่าขนส่ง ค่าจดทะเบียน และค่าใช้จ่ายอื่นๆ ทั้งปวง
 </div> 

<div class="div_edit" id="div_edit73" style="width:270px;height:60px;text-align: center;border:0px solid #ffee00;margin-left: 420px;margin-top: 60px;">
  ประกาศ ณ วันที่ <?=$dateday2?><br>
</div>
<div class="div_edit" id="div_edit74" style="width:270px;height:120px;text-align: center;border:0px solid #ffee00;margin-left: 420px;">
  <br>
<?=$director?>
</div>
</div>
...
<div style="width:350px;height:25px;text-align: center;margin:0px auto;font-size: 16px;padding: 15px;font-weight: bold;">ใบสั่งซื้อ</div>
...
<div class="div_edit" id="div_edit95" style="margin-left:80px;margin-top:10px;width:660px;">เพื่อนำมาประเมินผลการปฏิบัติงานของผุ้ประกอบการ</div> 
...
<div class="div_edit" id="div_edit97" style="margin-left:150px;width:580px;">๒. ใบสั่งซื็อสั่งจ้างนี้อ้างอิงตามเลขที่โครงการ ๖๒๐๕๗๔๙๒๘๓๑ <?=str_replace("จัด", "", $pcs_detail);?>โดยวิธี &nbsp;&nbsp;&nbsp;&nbsp;เฉพาะเจาะจง</div> 

<div class="div_edit" id="div_edit98" style="width:270px;height:120px;text-align: center;border:0px solid #ffee00;margin-left: 420px;padding-top:30px;">
  ลงชื่อ..................................................ผู้สั่งซื้อ
  <br>
<?=$director?>
</div>
...
<div style="margin-left: 430px;">วันที <div class="div_edit" id="div_edit100" style="margin-left: 50px;margin-top: -30px;"><?=$dateday2?></div></div> 
<div class="div_edit" id="div_edit101" style="width:300px;height:80px;text-align: center;border:0px solid #ffee00;margin-left: 420px;padding-top:20px;">
  ลงชื่อ..................................................ผู้รับใบสั่งซื้อ
  <br>
  (..................................................)<br>
  ..................................................<br>
  วันที่ ..................................................
...
<div class="div_edit" id="div_edit102" style="width:300px;height:80px;text-align: left;border:0px solid #ffee00;margin-left: 60px;margin-top: 30px;">
 เลขที่โครงการ ๖๒๐๕๗๔๙๒๘๓๑<br>
 เลขที่โครงการ ๖๒๐๕๑๔๓๙๕๓๒๕
</div>
</div>
...
<div class="div_edit" id="div_edit107" style="width:300px;height:80px;text-align: left;border:0px solid #ffee00;margin-left: 220px;margin-top:-30px;">
 เลขที่โครงการ ๖๒๐๕๗๔๙๒๘๓๑<br>
 เลขที่โครงการ ๖๒๐๕๑๔๓๙๕๓๒๕<br>
 เลขคุมตรวจรับ ๖๒๐๕A๑๔๙๓๒๐๘
</div>
