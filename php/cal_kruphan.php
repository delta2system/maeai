...
while ($data = mysql_fetch_array($result_t) ) {
$t=0;
$total_1=array("");
$total_2=array("");
$total[10]=array("");
...
echo "<thead>".
	 "<tr>".
	 "<td colspan='21' style='text-align:center;border:1px solid #a2a2a2;font-size:18px;font-weight:bold;'>ค่าเสื่อมราคาครุภัณฑ์ $data[detail] ".($now_year+543)."</td>".
...
// $strSQL .=",last_depreciate  = '".(($row[numberofsets]*$row[priceofsets])-1)."' ";
// $strSQL .=",jan  = '' ";
// $strSQL .=",feb  = '' ";
// $strSQL .=",mar  = '' ";
// $strSQL .=",api  = '' ";
