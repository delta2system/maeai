...
<table style="width:21cm;margin:0px auto;">
  <thead>
  	<tr><td colspan="6" style="text-align: center;font-size: 22px;font-weight: bold;">..::รายงานพัสดุคอมพิวเตอร์คงเหลือ:..</td><td colspan="2"  style="text-align: right;">ณ วันที่ <?=date("d")." ".thai_month(date("m"))." ".(date("Y")+543)?></td>
